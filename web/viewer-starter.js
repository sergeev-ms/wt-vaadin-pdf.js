...
function getViewerConfiguration() {
  return {
    ...
    printing: {
      printServiceOverlay: document.getElementById('printServiceOverlay'),
  ...
  function start() {
    var loader = lsps.widgets.wtPdfViewerFactory();
    var application = loader.webViewerLoad(getViewerConfiguration());
